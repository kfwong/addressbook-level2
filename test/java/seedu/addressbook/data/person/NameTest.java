...
public class NameTest {
    ...
    private Name differentOrder; // K Smith John
    ...
    public void setup() throws IllegalValueException {
        ...
        differentOrder = new Name("K Smith John");
    }
    ...
    @Test
    public void isSimilar_differentOrder() {
        boolean result = name.isSimilar(differentOrder);

        assertTrue("isSimilar: Different order", result);
    }
}
